        ...
        <div class="row" ng-controller="MemberController">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-6 col-lg-5">
                    <button class="btn green btn-circle" ng-click="modal('add')"><i class="fa fa-plus"></i> Thêm mới
                    </button>
                </div>
                <div class="col-xs-12 col-sm-8 col-md-6 col-lg-7">
                    <form method="get" action="">
                        <input type="text" class="search-class form-control" id="search" name="search"
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr ng-repeat="db in members | orderBy:sortType:sortReverse">
                            ...
                            <td class="text-center"><img class="img-thumbnail"
                                                         ng-src="{{asset('images')}}/@{{db.photo }}" class="imge"
                            ...
                            <td class="text-center">
                                <a href="#" class="btn btn-outline btn-circle green btn-sm purple idEdit"
                                   ng-click="modal('edit',db.id)">
                                    <i class="fa fa-list" aria-hidden="true"></i> Sửa
                                </a>
                                <a href="#" type="submit" class="btn btn-outline btn-circle dark btn-sm red"
                                   ng-click="confirmDelete(db.id)">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" name="formAdd" id="formMemberAdd" novalidate
                                  enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="usrname"></span> Name</label>
                                    <input type="text" class="form-control " ng-pattern="NameCharacter" name="name"
                                           ng-model="Member.name" ng-required="true" id="usrname"
                                           placeholder="Enter Your Name" ng-required="true" ng-maxlength="100">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gender" ng-model="Member.gender" class="form-control"
                                            ng-required="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" ng-pattern="NumAge" name="age" id="age"
                                           ng-model="Member.age" placeholder="Enter Age" ng-required="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="address" class="form-control" ng-model="Member.address"
                                              ng-maxlength='300' id="address" ng-required='true'></textarea>
            ...
            <div class="modal fade" id="myModalEdit" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" name="formEdit" id="formMemberEdit" novalidate
                                  enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="usrname"></span> Name</label>
                                    <input type="text" class="form-control " name="name" ng-pattern="NameCharacter"
                                           ng-model="MemberEdit.name" ng-required="true" id="usrname"
                                           placeholder="Enter Your Name" ng-required="true" ng-maxlength='100'>
                                    <input type="hidden" class="form-control " name="id" ng-model="MemberEdit.id"
                                           ng-required="true" value="@{{id}}" placeholder="Enter Your Name"
                                           ng-required="true">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <p class="font-red-mint error">@{{ messagesName }}</p>
                                ...
                                <div class="form-group">
                                    <label for="psw"> Gender </label>
                                    <select name="gender" ng-model="MemberEdit.gender" class="form-control"
                                            ng-required="true">
                                        <option value="">--Chọn--</option>
                                        }
                                ...
                                <div class="form-group">
                                    <label for="psw"> Age</label>
                                    <input type="text" class="form-control" ng-pattern="NumAge" name="age" id="age"
                                           ng-model="MemberEdit.age" placeholder="Enter Age" ng-required="true">
                                    <p class="font-red-mint error">@{{ messagesAge }}</p>
                                ...
                                <div class="form-group">
                                    <label for="psw"> Address</label>
                                    <textarea name="address" class="form-control" ng-model="MemberEdit.address"
                                ...
                                <button type="submit" class=" btn btn-default btn-success btn-block submit"
                                        ng-click="save(state,id)" ng-disabled="formEdit.$invalid"><span
                                            class="glyphicon glyphicon-off"></span> sửa
                                </button>
                            </form>
                        </div>
                    </div>
